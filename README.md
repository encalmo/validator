...
- [All batteries included](#all-batteries-included)
...
Use with SBT
    ...
    libraryDependencies += "org.encalmo" %% "validator" % "0.9.0"

or with SCALA-CLI

    //> using dep org.encalmo::validator:0.9.0
...
val validateIsNonEmpty: Validate[String] = 
    checkIsTrue[String](_.nonEmpty,fv vc "must be non-empty string") 
...
│       │       ├── validator
│       │       │   ├── Validator$$And.html
│       │       │   ├── Validator$$BigDecimalMatchers.html
│       │       │   ├── Validator$$BooleanOps.html
│       │       │   ├── Validator$$Error$.html
│       │       │   ├── Validator$$Error.html
│       │       │   ├── Validator$$IntMatchers.html
│       │       │   ├── Validator$$Invalid$.html
│       │       │   ├── Validator$$OptionalBigDecimalMatchers.html
│       │       │   ├── Validator$$OptionalIntMatchers.html
│       │       │   ├── Validator$$OptionalStringMatchers.html
│       │       │   ├── Validator$$Or.html
│       │       │   ├── Validator$$Single.html
│       │       │   ├── Validator$$StringMatchers.html
│       │       │   ├── Validator$$ValidateOps.html
│       │       │   ├── Validator$$ValidationResultOps.html
│       │       │   └── Validator$.html
│       │       │
│       │       └── validator.html
│       │
...
├── project.scala
├── README.md
├── StringMatchers.test.scala
├── test.sh
├── Validator.scala
├── Validator.test.scala
└── validator_3-0.9.0.zip
```
